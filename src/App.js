  ...
  return (
    ...
    <Route>
      <Switch>
        ...
        <Route path="/r/:communityurl" component={CommunityDashboard} />
        <Route path="/user/:username" component={UserDashboard} />
        <Route path="/blog-grid" component={GenericHeader} />
        <Route path="/blog-left-sidebar" exact component={BlogLeftSidebar} />
        <Route path="/blog-left-sidebar/:categoryid" exact  component={BlogLeftSidebar} />
        <Route path="/blog-right-sidebar" component={BlogRightSidebar} />
        <Route path="/post/:url" component={BlogDetail} />
